...
public class CassUnicastHostsProvider extends AbstractComponent implements UnicastHostsProvider {
...
//  private final IElasticCarInstanceFactory instanceFactory;
  ...
  @Inject
  public CassUnicastHostsProvider(Settings settings, TransportService transportService, Version version,IConfiguration config) {
    super(settings);
