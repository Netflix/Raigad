...
public class CassDiscovery extends ZenDiscovery {
  @Inject
  public CassDiscovery(Settings settings, ClusterName clusterName, ThreadPool threadPool, TransportService transportService,
                         ClusterService clusterService, NodeSettingsService nodeSettingsService, ZenPingService pingService,
                         DiscoveryNodeService discoveryNodeService, Version version,IConfiguration config) {
    ...
    if (unicastZenPing != null) {
      ...
      unicastZenPing.addHostsProvider(new CassUnicastHostsProvider(settings, transportService, version,config));
