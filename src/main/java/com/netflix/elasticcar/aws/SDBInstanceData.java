...
/*    public void registerInstance(ElasticCarInstance instance) throws AmazonServiceException
 ...
 /*   public void deregisterInstance(ElasticCarInstance instance) throws AmazonServiceException
    ...
    protected List<ReplaceableAttribute> createAttributesToRegister(ElasticCarInstance instance)
    {
    ...
    protected List<Attribute> createAttributesToDeRegister(ElasticCarInstance instance)
    {
    ...
    /**
     * Convert a simpledb item to ElasticCarInstance
     * 
     * @param item
     * @return
     */
/*    public ElasticCarInstance transform(Item item)
    ...
    private String getKey(ElasticCarInstance instance)
    {
