...
public class TestEsUtils {
	...
	public void TestInstaceToJson()
	{
		...
		JSONObject jsonInstances = EsUtils.transformRaigadInstanceToJson(instances);
		System.out.println(jsonInstances);
		List<RaigadInstance> returnedInstances = EsUtils.getRaigadInstancesFromJson(jsonInstances);
